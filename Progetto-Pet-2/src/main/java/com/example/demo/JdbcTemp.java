...
public class JdbcTemp {
    ...
    public int insertGame(String nome, String marca, double prezzo, String url) {
        String query = "INSERT INTO pet (nome, marca, prezzo, url, pezzi, pezziV) VALUES (?, ?, ?, ?,?,?)";
    ...
    public int setPrezzo(String nome, double prezzo) {
    	...
    	String query = "UPDATE pet SET prezzo = (?) WHERE nome = (?)";
    	return jdbcTemplateObject.update(query, prezzo, nome);
    }
    
    public int change(String nome, int pezzi) {
    	
    	String query = "UPDATE pet SET pezzi = pezzi - (?) WHERE nome = (?)";
    	jdbcTemplateObject.update(query, pezzi, nome);
    	String query1 = "UPDATE pet SET pezziV = pezziV + (?) WHERE nome = (?)";
    ...
    public ArrayList<pet> getLista() {
        ...
        return jdbcTemplateObject.query(query, new ResultSetExtractor<ArrayList<pet>>() {
        /*
         ...
         * */
        	@Override
            public ArrayList<pet> extractData(ResultSet rs) throws SQLException, DataAccessException {
                ArrayList<pet> listaP = new ArrayList<>();
